...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <Navbar widgetPos={widgetPos} handlePosChange={handlePosChange} />
        <div
          id="content"
          style={{
            display: "flex",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: "86vh",
              display: "flex",
              justifyContent: isWidgetLeft ? "flex-start" : "flex-end",
              alignItems: isWidgetBottom ? "flex-end" : "flex-start",
            }}
          >
            <div
              id="wrapper"
            ...
            >
              <div
                ...
                style={{
                  display: "flex",
                  flexDirection:
                    isWidgetLeft || isWidgetRight ? "column" : "row",
      ...
      <MapContainer center={[30.2566, 8.7522]} zoom={3.5} zoomControl={false}>
